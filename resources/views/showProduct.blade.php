...
@section('content')
    ...
    <div class="container-fluid py-5 mt-5">
        <div class="container py-5">
            <div class="row g-4 mb-5">
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <p class="mb-3">Catégorie: Vegetables</p>
                            ...
                            <nav>
                                <div class="nav nav-tabs mb-3">
                                    ...
                                    <button class="nav-link border-white border-bottom-0" type="button" role="tab"
                                        ...
                                        aria-controls="nav-mission" aria-selected="false">Commentaires</button>
                                </div>
                            </nav>
                            <div class="tab-content mb-5">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-6">
                                                ...
                                                <div class="row text-center align-items-center justify-content-center py-2">
                                                    <div class="col-6">
                                                        <p class="mb-0">Pays d'origine</p>
                                                    </div>
                                                    <div class="col-6">
                                                        <p class="mb-0">Ferme agricole</p>
                                                    </div>
                                                </div>
                                                <div
                                                    ...
                                                    <div class="col-6">
                                                        <p class="mb-0">Biologique</p>
                                                    </div>
                                                </div>
                                                <div class="row text-center align-items-center justify-content-center py-2">
                                                    <div class="col-6">
                                                        <p class="mb-0">Vérifier</p>
                                                    </div>
                                                    <div class="col-6">
                                                        <p class="mb-0">En bonne santé</p>
                                                    </div>
                                                </div>
                                                <div
                                                    class="row bg-light text-center align-items-center justify-content-center py-2">
                                                    <div class="col-6">
                                                        <p class="mb-0">Poids minimum</p>
                                                    </div>
                                                    <div class="col-6">
                                ...
                                <div class="tab-pane" id="nav-mission" role="tabpanel" aria-labelledby="nav-mission-tab">
                                    <div class="d-flex">
                                        ...
                                        <div class="">
                                            <p class="mb-2" style="font-size: 14px;">12 avril 2024</p>
                        ...
                        <form action="#">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="border-bottom rounded">
                                        <input type="email" class="form-control border-0" placeholder="Votre mail *">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="border-bottom rounded my-4">
                                        <textarea name="" id="" class="form-control border-0" cols="30" rows="8"
                                            placeholder="Votre commentaire*" spellcheck="false"></textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="d-flex justify-content-between py-3 mb-5">
                                        <div class="d-flex align-items-center">
                                            <p class="mb-0 me-3">Veuillez évaluer :</p>
                                        ...
                                        <a href="#"
                                            class="btn border border-secondary text-primary rounded-pill px-4 py-3"> Poster
                                            un
                                            Commentaire</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-xl-3">
                    <div class="row g-4 fruite">
                        ...
                        <div class="col-lg-12">
                            <h4 class="mb-4">Produits vedettes</h4>
                            ...
                            <div class="d-flex justify-content-center my-4">
                                <a href="#"
                                    class="btn border border-secondary px-4 py-3 rounded-pill text-primary w-100">Voir
            ...
            <h1 class="fw-bold mb-0">Produits apparentés</h1>
            <div class="vesitable">
                <div class="owl-carousel vegetable-carousel justify-content-center">
                    <div class="border border-primary rounded position-relative vesitable-item">
                        ...
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Légumes</div>
                    ...
                    <div class="border border-primary rounded position-relative vesitable-item">
                        ...
                        <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                            style="top: 10px; right: 10px;">Légume</div>
                        <div class="p-4 pb-0 rounded-bottom">
                            <h4>Banana</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                            <div class="d-flex justify-content-between flex-lg-wrap">
