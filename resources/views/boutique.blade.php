                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <div class="row g-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-3" name="Categories-1"
                                                value="Beverages">
                                            <label for="Categories-3"> Vente</label>
                                        </div>
                                        <div class="mb-2">
                                            <input type="radio" class="me-2" id="Categories-4" name="Categories-1"
                                                value="Beverages">
                                            <label for="Categories-4"> Remise</label>
                                        </div>
                                        <div class="mb-2">
                                ...
                                <div class="col-lg-12">
                                    <h4 class="mb-3">Produits vedettes</h4>
                                    <div class="d-flex align-items-center justify-content-start">
                                        <div class="rounded me-4" style="width: 100px; height: 100px;">
                                            <img src="img/featur-1.jpg" class="img-fluid rounded" alt="">
                                        </div>
                                        <div>
                                            <h6 class="mb-2">Gros Banane</h6>
                                ...
                                <div class="col-lg-12">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute"
                                            ...
                                            <h3 class="text-secondary fw-bold">Fruits<br> frais</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="p-4 border border-secondary border-top-0 rounded-bottom">
    ...
    <div class="d-flex justify-content-between flex-lg-wrap">
        <p class="text-dark fs-5 fw-bold mb-0">f{{ $product->price }} / kg
        </p>
        <a href="{{ route('home.cart') }}" class="btn border border-secondary rounded-pill px-3 text-primary">
