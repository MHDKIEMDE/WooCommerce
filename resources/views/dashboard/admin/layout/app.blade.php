                    ...
                    <div class="nav">
                                ...
                                <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne"
                                    ...
                                    <nav class="sb-sidenav-menu-nested nav">
                                        <a class="nav-link" href="{{ route('produits.create') }}">Ajouter un
                                            produit</a>
                                        <a class="nav-link" href="{{ route('produits.index') }}">Voir la listes de tous les
                                            produit</a>
                                        <a class="nav-link" href="#"></a>
                                    </nav>
                                </div>
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link" href="{{ route('categories.create') }}">Ajouter une categories</a>
                            </nav>
                        </div>
                        <div class="sb-sidenav-menu-heading">Gestion des utilisateurs</div>
                        <a class="nav-link" href="charts.html">
                            <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                            listes de tous les utilisateur
                        </a>
                        <a class="nav-link" href="#">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            listes de tous les commandes
                        </a>
                    </div>
                </div>
            </nav>
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Agribusiness shop 2024</div>
                        <div>
